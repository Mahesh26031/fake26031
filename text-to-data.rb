...
def get_data_from_each_line(destinations,text,client)
  ...
  text.each do |line|
      ...
      activity = get_activity(line,client)
      day = get_day(line)
      destinations.push([activity,day])            
...
client = OpenAI::Client.new(api_key: "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")
text = input_data
...
get_data_from_each_line(destinations,days,client)
